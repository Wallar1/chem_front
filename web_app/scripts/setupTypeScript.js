...
// mv web_app/main.js to main.ts - note, we need to edit rollup.config.js for this too
...
function updateSingleSvelteFile({ view, vars, contextModule }) {
	replaceInFile(path.join(projectRoot, 'web_app', `${view}.svelte`), [
...
function createTsConfig() {
	const tsconfig = `{
		...
		"include": ["/web_app/**/*", "/web_app/node_modules/**/*"],
...
changeJsExtensionToTs(path.join(projectRoot, 'web_app'));
