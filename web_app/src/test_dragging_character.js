...
export class TestDraggingDemo {
    ...
    _LoadModels() {
        ...
        this.fbx_loader.load('monster.fbx', (fbx) => {
            ...
            let controls = new DragControls( [ this._model ], this._camera, this._threejs.domElement );
            controls.transformGroup = true;
            controls.addEventListener( 'drag', () => this._render() );
